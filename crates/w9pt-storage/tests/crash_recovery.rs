...
fn assert_reopen_is_atomic(stage: FailureStage) {
    ...
    let update_identity = w9pt_storage::PreparationIdentity::for_write(
        update_mutation,
        published.content(),
        0,
        &new_bytes,
    ...
    match stage {
        ...
        FailureStage::Payload(_) | FailureStage::Manifest(_) | FailureStage::HeadBefore => {
...
#[test]
fn failures_before_and_after_payload_and_manifest_keep_old_head_complete() {
    for stage in [
