...
const RUNTIME_PRIVILEGES: &[PrivilegeRequirement] = &[
    ...
    privilege("w9pt_fs_state_content_metadata", RuntimePrivilege::Select),
    privilege("w9pt_fs_state_content_metadata", RuntimePrivilege::Insert),
    privilege("w9pt_fs_state_content_metadata", RuntimePrivilege::Update),
